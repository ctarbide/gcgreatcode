...
void Indent_CmtCommentFirstLine(FileDes *pfile)
{
	...
	for(pcur = pfile->pst_RootToken; pcur; pcur = NextToken(pcur))
	{
		...
		/*$I
		 /--------------------------------------------------------------------\
		 | Copyright (C) 2004 Christophe Beaudet.                             |
		 | All rights reserved.                                               |
		 |                                                                    |
		 | email: cbeaudet@club-internet.fr                                   |
		 | web:   perso.club-internet.fr/cbeaudet                             |
		 |                                                                    |
		 ...
		 |                                                                    |
		 | The text of the GNU Lesser General Public License is included with |
		 | this library in the file LICENCE.txt.                              |
		 |                                                                    |
